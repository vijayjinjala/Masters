        ...
        return props.tabledata.map((element) => {
            ...
            return (
                <tr className='table-info'>
                    ...
                    <td>
                            <button type='button' className='btn btn-danger m-1'><i class="bi bi-pencil-square" onClick={() => editdata(element._id)}></i></button>
                                <button type='button' className='btn btn-warning' onClick={() => deletedata(element._id)}><i class="bi bi-trash3-fill"></i></button>
                    </td>
                </tr>
            )
        })
